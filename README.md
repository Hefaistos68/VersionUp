...
**VersionUp** is a Visual Studio and VScode extension that allows developers to quickly and easily increment the version of C#/.NET projects directly from the Solution Explorer context menu.
